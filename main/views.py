...
from .forms import ProfileForm, ImageForm, MessageForm, DMPostForm, PotentialClient
...
#from .serializers import UserLoginSerializer, UserRegisterSerializer, UserChangePasswordSerializer
...
service_account_email = "test-247@main-3197a.iam.gserviceaccount.com"
SCOPES = ["https://www.googleapis.com/auth/calendar"]

credentials = service_account.Credentials.from_service_account_file('main-3197a-809a2e2c5da6.json')
...
def quote_schedule(request):
    ...
    if request.method == 'POST':
        if form.is_valid():
            ...
            Content.save()
            form = QuoteForm(request.POST or None, instance=Content)
            form.save()
            return HttpResponse('<script>history.back();</script>')
    else:
        form = QuoteForm()
    return render(request, 'main/common/quote-schedule.html',{'form': form,})  
...
def register(request):
    ...
    return render(request, 'main/common/register.html') 
