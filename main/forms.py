...
from .models import Report, Message, user_pics, Topic, Job, PotentialClient
...
class QuoteForm(forms.ModelForm):
    ...
    date_scheduled = forms.DateField(label="Date Needed", widget=forms.SelectDateWidget(), required=False,)

    class Meta:
        model = PotentialClient
        fields = ('name', 'phone', 'email', 'date_scheduled',)        
